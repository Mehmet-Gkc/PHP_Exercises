...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        if(empty($_POST["beschreibung"])) {
            $beschreibungErr = "Man muss eine Beschreibung schreiben.";
        } else {
            $beschreibung = safe_html($_POST["beschreibung"]);
        };        
        ...
        if(empty($titleErr) && empty($unterTitleErr) && empty($imgErr) && empty($categoryErr)) {
            editCourse($id,$title,$unterTitle,$beschreibung,$img,$category,$urkunde);
            ...
            <div class="card card-body">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="beschreibung" class="form-control"><?php echo $selectedCourse["beschreibung"];?></textarea>
                        <div class="text-danger"><?php echo $beschreibungErr; ?></div>
                    </div>
                    <!--
